...
const server = http.createServer(async (req, res) => {
  try {
    ...
    if (urlObj.pathname === '/api/health') return sendJson(res, 200, { ok: true, service: 'Bel Canto Score Search', version: '1.4', time: new Date().toISOString() }, 'no-cache');
...
server.listen(PORT, () => {
  console.log(`Bel Canto Score Search v4 running at http://localhost:${PORT}`);
});
